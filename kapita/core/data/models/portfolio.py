...
class PortfolioModel(BaseModel):
    ...
    title: sa_orm.Mapped[str] = sa_orm.mapped_column(sa.String(64), nullable=False)
    ...
    is_active: sa_orm.Mapped[bool] = sa_orm.mapped_column(nullable=False, default=True, server_default=sa.true())
